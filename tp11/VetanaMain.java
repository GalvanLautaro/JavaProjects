...
public class VetanaMain extends JFrame implements ActionListener {
	...
	private JListPersonaje list;
	private JListPersonaje list_1;
	...
	private DefaultListModelPersonaje modeloLista = new DefaultListModelPersonaje();	
	...
	public VetanaMain() {
		...
		this.list_1 = new JListPersonaje();
	...
	if (ganador != null)
	    mensaje = nEl ganador es  + ganador.getNombre() +  con  + atributo;
	else 
	    mensaje = Empate o no hay ganadorn;	
	...
	protected void do_buttonAdd_actionPerformed(ActionEvent e) {
		...
		this.textArea.append(Se agrego el personajen);
	}
	...
	protected void do_buttonDelete_actionPerformed(ActionEvent e) {
		...
		if(p != null) {
			...
			this.actualizaLista();
			this.textArea.append(Se elimino el personajen);
		}
	}
	...
	private void actualizaLista() {
		...
		IteratorPersonaje iterator = this.juego.getPersonajes();
